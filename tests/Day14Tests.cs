...
namespace tests
{
    public class Day14Tests
    {
        ...
        [Fact]
        public void GetXRangeForPart1WorksAsExpected()
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var result = sut.GetXRange(1);
            result.minX.Should().Be(494);
            result.maxX.Should().Be(503);
        }

        [Fact]
        public void GetYRangeForPart1WorksAsExpected()
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            sut.GetMaxY(1).Should().Be(9);
        }
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var result = sut.GenerateBaseMap(1);
        ...
        public void GenerateBaseMapWithMyExampleInputWorksAsExpected()
        {
            ...
            var map = sut.GenerateBaseMap(1);
            string.Join('\n', map.Map.Select(line => new string(line))).Should().Be(
                """
                  4 55
                  9 00
                  8 01
            ...
            var result1 = Day14.Simulate(1, sut.GenerateBaseMap(1));
            ...
            var result2 = Day14.Simulate(2, sut.GenerateBaseMap(1));
            ...
            var result3 = Day14.Simulate(3, sut.GenerateBaseMap(1));
        ...
        [Fact]
        public void GenerateBaseMapPart2WorksAsExpected()
        {
            var sut = new Day14(allowFallToRight.Split('\n'));
            var map = sut.GenerateBaseMap(2);
            var mapVisual = string.Join('\n', map.Map.Select(line => new string(line)));
            mapVisual.Should().Be(
                """
                  -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           
                  1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          2
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            sut.GetAnswerForPart2().Should().Be("93");
        }
        ...
        public void Part2WithActualInputProducesCorrectResult()
        {
            ...
            sut.GetAnswerForPart2().Should().Be("25193");
        }
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var sandMap = sut.GenerateBaseMap(1);
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var result = Day14.Simulate(1, sut.GenerateBaseMap(1));
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var result = Day14.Simulate(2, sut.GenerateBaseMap(1));
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var result = Day14.Simulate(5, sut.GenerateBaseMap(1));
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var result = Day14.Simulate(22, sut.GenerateBaseMap(1));
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var result = Day14.Simulate(24, sut.GenerateBaseMap(1));
        ...
        {
            var sut = new Day14(exampleInput1.Split('\n'));
            var result = Day14.Simulate(25, sut.GenerateBaseMap(1));
        ...
        public void GenerateBaseMapWithRealDataWorksAsExpected()
        {
            ...
            var sut = new Day14(input);
            var result = string.Join('\n', sut.GenerateBaseMap(1).Map.Select(ca => new string(ca)));
